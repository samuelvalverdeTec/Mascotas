...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tModifLbl1->Text = L"Código Tratamiento";
			// 
			// tModifTxtbx1
			// 
			...
			this->mElimLbl1->Text = L"Código Medicacion";
			// 
			// mElimTxtbx1
			// 
			...
			this->tElimLbl1->Text = L"Código Tratamiento";
			// 
			// tElimTxtbx1
			// 
			...
			this->mModifLbl1->Text = L"Código Medicacion";
			// 
			// mModifLbl2
			// 

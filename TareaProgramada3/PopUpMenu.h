...
private: System::Windows::Forms::TextBox^ txtBusqTrat2;
private: System::Windows::Forms::TextBox^ txtBusqTrat4;


	private: System::Windows::Forms::Label^ lblBuscarTrat3;
	private: System::Windows::Forms::Label^ lblBuscarTrat4;
private: System::Windows::Forms::TextBox^ txtBusqTrat3;

	private: System::Windows::Forms::Button^ bBuscarTratamiento;
private: System::Windows::Forms::TextBox^ txtBusqTrat1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txtBusqTrat2 = (gcnew System::Windows::Forms::TextBox());
			this->txtBusqTrat4 = (gcnew System::Windows::Forms::TextBox());
			this->lblBuscarTrat3 = (gcnew System::Windows::Forms::Label());
			this->lblBuscarTrat4 = (gcnew System::Windows::Forms::Label());
			this->txtBusqTrat3 = (gcnew System::Windows::Forms::TextBox());
			this->bBuscarTratamiento = (gcnew System::Windows::Forms::Button());
			this->txtBusqTrat1 = (gcnew System::Windows::Forms::TextBox());
...
#pragma endregion
	...
	private: System::Void bInserMascota_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (clienteBuscado != NULL) {
			...
			if (mascotaBuscada == NULL) {
				arbolMascotas->InsertaNodoMascota(codigoCliente, codigoAnimal, nombreAnimal, tipoAnimal, razaAnimal, 
					fechaNacimiento, sexoAnimal, colorAnimal, castradoAnimal, ultimaVisita);
				MessageBox::Show(exito);
			}
			else {
				MessageBox::Show(error);
	...
	private: System::Void bBuscarPais_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ codPais = this->txtBusqPais1->Text;
		...
		if (paisBuscado != NULL) {
			String^ nombre = marshal_as<String^, string>(paisBuscado->nombre);
			this->txtBusqPais2->Text = nombre;
			this->lblBusqPais2->Show();
			this->txtBusqPais2->Show();
		}
		else {
			MessageBox::Show(error);
		}
	...
	private: System::Void bBuscarCiudad_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int codigoP = stoi(marshal_as<string, String^>(this->txtBusqCiudad1->Text));
		int codigoC = stoi(marshal_as<string, String^>(this->txtBusqCiudad2->Text));

		pNodoBinarioPaises paisBuscado = arbolPaises->buscaPais(arbolPaises->raiz, codigoP);
		if (paisBuscado != NULL) {
			pNodoBinarioCiudades ciudadBuscada = arbolCiudades->buscaCiudadRepetida(arbolCiudades->raiz, codigoP, codigoC);
			if (ciudadBuscada != NULL) {
				String^ nombre = marshal_as<String^, string>(ciudadBuscada->nombre);
				this->txtBusqCiudad3->Text = nombre;

				this->lblBusqCiudad3->Show();
				this->txtBusqCiudad3->Show();
			}
			else {
				MessageBox::Show(errorC);
			}
	...
	private: System::Void bBuscarCliente_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int codigoP = stoi(marshal_as<string, String^>(this->txtBusqCliente1->Text));
		int codigoCiudad = stoi(marshal_as<string, String^>(this->txtBusqCliente2->Text));
		int codigoCliente = stoi(marshal_as<string, String^>(this->txtBusqCliente3->Text));
		...
		if (paisBuscado != NULL) {
			...
			if (ciudadBuscada != NULL) {
				...
				if (clienteBuscado != NULL) {
					...
					this->txtBusqCliente4->Text = marshal_as<String^, string>(clienteBuscado->nombre);
					this->txtBusqCliente5->Text = marshal_as<String^, string>(clienteBuscado->direccion);
					this->txtBusqCliente6->Text = marshal_as<String^, string>(to_string(clienteBuscado->telefono));

					this->pBuscarCliente->Show();
	...
	private: System::Void bBuscarMascota_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int codigoCliente = stoi(marshal_as<string, String^>(this->txtBusqMascota1->Text));
		int codigoAnimal = stoi(marshal_as<string, String^>(this->txtBusqMascota2->Text));
		...
		if (clienteBuscado != NULL) {
			...
			if (mascotaBuscada != NULL) {
				...
				String^ nomAnimal = marshal_as<String^, string>(mascotaBuscada->nombre);
				String^ tipo = marshal_as<String^, string>(mascotaBuscada->tipoMascota);
				String^ raza = marshal_as<String^, string>(mascotaBuscada->raza);
				String^ fNacimiento = marshal_as<String^, string>(mascotaBuscada->fechaNacimiento);
				String^ ultVisita = marshal_as<String^, string>(mascotaBuscada->ultimaVisita);
				String^ sexo = marshal_as<String^, string>(mascotaBuscada->sexo);
				String^ color = marshal_as<String^, string>(mascotaBuscada->color);
				String^ castrado = marshal_as<String^, string>(mascotaBuscada->castrado);

				this->txtBusqMascota3->Text = nomAnimal;
				this->txtBusqMascota4->Text = tipo;
				this->txtBusqMascota5->Text = raza;
				this->txtBusqMascota6->Text = fNacimiento;
				this->txtBusqMascota7->Text = ultVisita;
				this->txtBusqMascota8->Text = sexo;
				this->txtBusqMascota9->Text = color;
				this->txtBusqMascota10->Text = castrado;

				this->pBuscarMascota->Show();
	...
	private: System::Void bBuscarTratamiento_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ errorT = "El codigo de tratamiento no existe";

		int codigoT = stoi(marshal_as<string, String^>(this->txtBusqTrat1->Text));

		pNodoRNTratamiento tratamientoBuscado = arbolTratamientos->buscaTratamiento(arbolTratamientos->raiz, codigoT);
		if (tratamientoBuscado != NULL) {
			
			this->txtBusqTrat2->Text = marshal_as<String^, string>(tratamientoBuscado->nombreTratamiento);
			this->txtBusqTrat3->Text = marshal_as<String^, string>(to_string(tratamientoBuscado->precio));
			this->txtBusqTrat4->Text = marshal_as<String^, string>(to_string(tratamientoBuscado->cantidad));

			this->pBuscarTratamiento->Show();
